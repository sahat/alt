...
},{"./mixinContainer":3,"object-assign":10,"react/addons":undefined}],3:[function(require,module,exports){
"use strict";
...
function mixinContainer(React) {
  return {
    ...
    reduceState: function reduceState(props) {
      return assign({}, this.getStateFromStores(props), this.getStateFromActions(props));
    },
